<template>
  <div
    class="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-white py-10"
  >
    <!-- Header -->
    ...
    <div class="w-full md:w-[70%] md:mx-auto">
      <div class="w-full self-center md:w-[80%] md:mx-auto">
        <u-i-progress-bar />
      </div>
      ...
      >
        Let's personalize your journey. What are you most interested in
        learning?
      </p>
      ...
      <!-- Footer Button -->
      <footer
        class="flex flex-col bottom-0 left-0 right-0 bg-white pt-4 pb-6 px-4 md:px-6"
      >
        <button
          @click="handleContinue"
          class="w-full py-3 md:py-4 px-5 bg-green-500 hover:bg-emerald-900 text-white font-bold rounded-full text-base md:text-lg transition-colors duration-200 disabled:bg-gray-300 disabled:cursor-not-allowed md:w-[50%] md:self-center"
